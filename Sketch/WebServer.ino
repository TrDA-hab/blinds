...
String getPage() {
 ...
 // webpage += "<tr><td>MOTOR_STEPS<div class='form-text text-muted small'>200 для шаговика NEMA-17</div></td><td>"+formControlInput("MOTOR_STEPS", String(MOTOR_STEPS))+"</td></tr>";
 ...
 // webpage += "<tr><td>MOTOR_MICROSTEPS<div class='form-text text-muted small'>Режим микрошага: 1 - full, 2 - half (в два раза дольше)</div></td><td>"+formControlSelect("MOTOR_MICROSTEPS", String(MOTOR_MICROSTEPS), choiceMicroSteps, 2)+"</td></tr>";
  ...
  int choiceMotorRpm[] = {50,100,150,200,250,300,350,400,450,500,600,700,800,900,1000,1250,1500,1750,2000,2500,3000,3500,4000,4500,5000,5500,6000,7000,8000,9000};
  webpage += "<tr><td>MOTOR_RPM<div class='form-text text-muted small'>Количество оборотов в минуту. NEMA-17 нормально поддерживает до 3000-6000rpm, однако, если поставить больше, это отразится на скорости из-за кривой разгона.</div></td><td>"+formControlSelect("MOTOR_RPM", String(MOTOR_RPM), choiceMotorRpm, 30)+"</td></tr>";
  ...
  webpage += "<tr><td>MOTOR_DECEL<div class='form-text text-muted small'>Как быстро мотор остановится. Чем плавнее останавливается, тем выше крутящий момент.</div></td><td>"+formControlInput("MOTOR_DECEL", String(MOTOR_DECEL))+"</td></tr>";
